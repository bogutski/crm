...
/**
 * ContactTimeline - компонент для отображения истории взаимодействий с контактом
 *
 * Планируемый функционал:
 * - Timeline событий (звонки, встречи, задачи, изменения)
 * - История переписки (email, SMS, чаты)
    ...
    <div className="flex flex-col flex-1 min-h-0 p-6">
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center overflow-y-auto">
        ...
        <p className="text-xs text-zinc-400 dark:text-zinc-500 max-w-[200px]">
          Здесь будет отображаться история взаимодействий с контактом
        </p>
      </div>
    </div>
  );
