...
// Props interface matching Lucide's pattern
...
export function Icon({ name, size = 24, className, fill, ...props }: UnifiedIconProps) {
...
// Re-export LucideIcon type for cases where direct Lucide import is needed
